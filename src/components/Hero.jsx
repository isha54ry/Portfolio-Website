...
const handleResumeClick = () => {
  ...
  return (
    ...
    >
      {/* Blurred modern background image */}
      <img
        ...
        className="absolute inset-0 w-full h-full object-cover object-center z-0 blur-lg brightness-75"
        aria-hidden="true"
      />
      <div className="container mx-auto relative z-10">
        <div className="flex flex-col items-center text-center">
          ...
          >
            Isha <span className="text-[#1d1d1e]">Raj</span>
          </motion.h1>
          ...
          <motion.p
            ...
            className="text-lg md:text-xl text-[#0F172A] mb-8 max-w-2xl" // changed to navy blue
          >
          ...
          >
            <Button
              ...
              className="bg-[#0F172A] hover:bg-[#1e293b] text-white px-8 py-6 text-lg shadow-lg hover:shadow-xl transition-all duration-300 border-none font-semibold"
            >
